...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("shaders/2.5.light_casters.vs", "shaders/2.5.4.light_casters_spotlight_soft_edge.fs");
    Shader lightCubeShader("shaders/2.5.light_cube.vs", "shaders/2.5.light_cube.fs");
